...
def get_movies(x):
    ...
    button_4 = Button(
        ...
        borderwidth=0,
        highlightthickness=0,
        command=lambda: getSingleMovie(movies[4]),
        relief="flat"
    )
    ...
    button_3 = Button(
        ...
        borderwidth=0,
        highlightthickness=0,
        command=lambda: getSingleMovie(movies[3]),
        relief="flat"
    )
    ...
    button_2 = Button(
        ...
        borderwidth=0,
        highlightthickness=0,
        command=lambda: getSingleMovie(movies[2]),
        relief="flat"
    )
    ...
    button_1 = Button(
        ...
        borderwidth=0,
        highlightthickness=0,
        command=lambda: getSingleMovie(movies[1]),
        relief="flat"
    )
    ...
    button_0 = Button(
        ...
        borderwidth=0,
        highlightthickness=0,
        command=lambda: getSingleMovie(movies[0]),
        relief="flat"
    )
    button_0.image = button_image_0
    button_0.pack()
